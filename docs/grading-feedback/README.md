...
- Consistency matters: Coordinate with other TAs to ensure fairness.  
...
## Best Practices
### When Grading
- Leave at least one positive note along with corrections.  
- Avoid vague comments like “unclear” – instead, explain what could be improved.  

### When Giving Feedback
- Be specific: “Your SQL query works but could be simplified with a JOIN.”  
- Be actionable: Suggest next steps for improvement.  
...
- Over-commenting on trivial style issues instead of conceptual errors.  
